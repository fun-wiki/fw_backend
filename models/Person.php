...
class Person extends Model
{
    ...
    public $belongsToMany = [
        ...
        'genres' => ['fw\Backend\Models\Genre', 'table' => 'fw_backend_relation_persons_genres'],
        'universes' => ['fw\Backend\Models\Universe', 'table' => 'fw_backend_relation_universes_persons'],
        'personroles' => ['fw\Backend\Models\PersonRole', 'table' => 'fw_backend_persons_persons_roles'] // исправить
    ];
